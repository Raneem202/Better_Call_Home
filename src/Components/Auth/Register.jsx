...
const SignUp = () => {
  ...
  return (
    <div className=" bor">
      <Row className="m-0">
        <Col xs="9" md="6" className="m-0 bg-white">
          <div className=" text-center px-5">
            <div className=" text-start login-header p-2 pt-5 line-space">
              Create Account
            </div>
            <div className="my-5">
              ...
              <Form>
                ...
                <div className=" d-flex justify-content-around mb-2">
                  <div>
                    ...
                    />
                    <label className="mx-2 pointer" htmlFor="male">
                      Male
                    </label>
                  </div>
                  <div>
                    <input
                      ...
                      className="form-check-input ml-2 pointer"
                    />
                    <label className=" mx-2 pointer" htmlFor="female">
                      Female
                    </label>
                  </div>
                </div>
        ...
        <Col xs="3" md="6" className="m-0 p-0">
          <img
            src={img}
