...
const Login = () => {
  ...
  return (
    <div className="">
      <Row className="m-0 ">
        <Col xs="4" md="6" className="m-0 p-0">
          <img
            src={img}
        ...
        <Col xs="8" md="6" className="m-0 bg-white">
          <div className=" text-center px-5 pt-5">
            <div className=" text-start login-header p-2 line-space">LOGIN</div>
            <div>
            ...
            <div>
              <Form>
                ...
                <p className="coloring fonted missed">
                ...
                <div className="signwith d-flex justify-content-between flex-wrap">
